...
public partial class axCarrosManiagroContext : DbContext
{
    ...
    public virtual DbSet<SecadoraCarro> SecadorasCarros { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SecadoraCarro>(entity =>
        {
            entity.HasKey(e => new { e.IdSecadora, e.IdCarro });

            entity.ToTable("Secadora_Carro");

            entity.HasIndex(e => e.IdUsuario, "IX_secadora_carro_usuario");

            entity.Property(e => e.IdSecadora).HasColumnName("id_secadora");
            entity.Property(e => e.IdCarro).HasColumnName("id_carro");
            entity.Property(e => e.IdUsuario).HasColumnName("id_usuario");

            entity.HasOne(d => d.IdCarroNavigation).WithMany(p => p.SecadorasCarros)
                .HasForeignKey(d => d.IdCarro)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SC_Carro");

            entity.HasOne(d => d.IdSecadoraNavigation).WithMany(p => p.SecadorasCarros)
                .HasForeignKey(d => d.IdSecadora)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SC_Secadora");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.SecadorasCarros)
                .HasForeignKey(d => d.IdUsuario)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SC_Usuario");
        });
